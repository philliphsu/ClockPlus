 ...
 * uses our {@link RingtonePickerDialog} instead of the system's ringtone picker.</p> Because
 * of this difference, we cannot just extend from <var>RingtonePreference</var> and make
 * our modifications.
 */
