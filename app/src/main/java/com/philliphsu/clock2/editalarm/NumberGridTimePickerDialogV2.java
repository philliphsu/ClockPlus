 ...
 */
public class NumberGridTimePickerDialogV2 extends BaseTimePickerDialog /*DialogFragment implements OnValueSelectedListener*/{
...
//        void onTimeSet(RadialPickerLayout view, int hourOfDay, int minute);
    ...
    public NumberGridTimePickerDialogV2() {
...
//    }
    ...
    public static NumberGridTimePickerDialogV2 newInstance(OnTimeSetListener callback,
                                               int hourOfDay, int minute, boolean is24HourMode) {
        NumberGridTimePickerDialogV2 ret = new NumberGridTimePickerDialogV2();
     ...
     */
    public static NumberGridTimePickerDialogV2 newInstance(int timeFieldIndex, int initialHalfDay) {
        NumberGridTimePickerDialogV2 dialog = new NumberGridTimePickerDialogV2();
